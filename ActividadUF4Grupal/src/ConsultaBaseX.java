...
public class ConsultaBaseX {
	public static void main(String[] args) {
		...
		sentencia = "for $rec in fn:collection('recibosBD')/recibos/recibo/detalle order by $rec/codigo return $rec"; 
		/*
		 * 
		 * 
		 * -----""OJO"" AQUI MI BASE DE DATOS SE LLAMA recibosBD------
		 * 
		 * 
		 * */		
