...
public class JDOM {
	public static void main(String[] args) {
		DocumentBuilderFactory fabrica = DocumentBuilderFactory.newInstance(); //obtener el objeto DocumentBuilder a partir de su m�todo newInstante().
		DocumentBuilder analizador;
		/*
		 * La clase DocumentBuilder , situada en el paquete javax.xml.parsers, representa un analizador
		 * o parser cuyos objetos nos permiten construir el �rbol DOM a partir del documento XML por
		 * medio de su m�todo parse().
		 */
		Document doc;
		Node raiz;
		...
		try {
			...
			doc = analizador.parse("xml//recibos.xml");//Es tarea del objeto DocumentBuilder analizar el contenido del documento XML y devolver el objeto Document con el �rbol DOM
			raiz = doc.getDocumentElement(); //El m�todo getDocumentElement() de la clase Document devuelve el objeto Node que representa el nodo ra�z
