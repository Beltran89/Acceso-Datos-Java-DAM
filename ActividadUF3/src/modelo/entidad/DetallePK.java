...
import javax.persistence.*;
	...
	/*
	 * La anotacion @Embeddable va delante de una clase que tiene como función embeber una clave primaria compuesta.
	 * */
...
public class DetallePK implements Serializable {
	...
	/* 
	 * La anotación @Column con los atributos insertable y con los valores false, provoca que el atributo que acompaña no sea tenido en cuenta 
